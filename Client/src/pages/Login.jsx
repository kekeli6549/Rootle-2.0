      ...
      >
        ...
        <form onSubmit={handleLogin} className="space-y-6 flex-grow">
          ...
          <div>
            ...
            <input required type="password" name="password" onChange={handleChange} className="w-full bg-white border-2 border-[#3E2723] p-4 rounded-xl outline-none focus:ring-2 focus:ring-[#A0522D] transition-all font-bold text-[#3E2723]" placeholder="••••••••" />
          </div>
          ...
          <motion.button 
            ...
            className="w-full bg-[#3E2723] text-[#F5F5DC] py-4 rounded-xl font-black text-lg shadow-lg transition-all mt-4 border-2 border-transparent hover:border-[#A0522D] disabled:opacity-50"
          >
