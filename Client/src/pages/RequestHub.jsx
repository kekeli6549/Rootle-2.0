    ...
    <div className="min-h-screen p-6 md:p-12 relative" style={{ backgroundColor: '#F5F5DC', backgroundImage: `url(${scribbleBg})`, backgroundSize: '400px' }}>
      <div className="flex justify-between items-center mb-12">
        <div>
          ...
          <p className="text-[#5D4037] font-medium italic">Ask for what you need. Provide what you have. 🌍</p>
        </div>
        <div className="flex gap-4">
            <button onClick={() => navigate(-1)} className="px-6 py-2 border-2 border-[#3E2723] rounded-full font-bold text-[#3E2723] hover:bg-[#D7CCC8] transition">Back</button>
            <button onClick={() => setShowRequestModal(true)} className="px-8 py-3 bg-[#3E2723] text-[#F5F5DC] rounded-full font-black shadow-[4px_4px_0px_0px_rgba(62,39,35,0.8)]">+ New Request</button>
        </div>
      </div>
